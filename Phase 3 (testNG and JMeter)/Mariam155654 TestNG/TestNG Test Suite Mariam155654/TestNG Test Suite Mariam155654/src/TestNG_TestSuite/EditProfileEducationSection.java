...
public class EditProfileEducationSection extends EditProfileProfessionalSection {
  ...
  public void main() throws InterruptedException{
	  try {
		...
		Assert.assertTrue(driver.findElement(By.xpath("//*[@id=\"education\"]/div[1]/div/div/button")).isDisplayed());
