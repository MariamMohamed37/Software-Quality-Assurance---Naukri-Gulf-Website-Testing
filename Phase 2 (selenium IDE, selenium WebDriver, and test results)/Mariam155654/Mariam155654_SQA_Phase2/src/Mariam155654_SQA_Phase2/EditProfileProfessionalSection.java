...
public class EditProfileProfessionalSection {
	public EditProfileProfessionalSection() {
		
	}
	
	public WebDriver editProfileProfessionalSection() throws InterruptedException {
